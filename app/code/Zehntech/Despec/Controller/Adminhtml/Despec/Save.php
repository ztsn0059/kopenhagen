...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!$data) {
            $this->_redirect('despecfile/despec/addrow');
            return;
        }
        ...
        if (isset($_FILES['file']['name']) && $_FILES['file']['name'] != '') {
            ...
            try {
                ...
                */
                ...
                $destinationPath = $mediaDirectory->getAbsolutePath('zehntech/despec');
                ...
                $imagePath = 'zehntech/despec' . $result['file'];
                $data['file'] = $imagePath;
                $data['status'] = 1;
        ...
        $this->_redirect('despecfile/despec/index');
    }
    ...
    {
        return $this->_authorization->isAllowed('Zehntech_Despec::save');
    }
}