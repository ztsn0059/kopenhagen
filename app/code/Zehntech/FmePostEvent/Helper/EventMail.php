...
class EventMail extends AbstractHelper
{
    const NAME = "Pave Tech Admin";
    const EMAIL = "sumit@thrivesys.com";

    const XML_PATH_EMAIL_TEMPLATE_FIELD = 'zehntech_fmepostevent_email_template';
     ...
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    public function notify($name, $email, $event)
    {
        ...
        $variable = [
            'admin' => 'PaveTech',
            'subject' => 'An event has been submitted...',
            'name' => $name,
            'email' => $email,
            'eventname' => $event
        ];
        ...
        $this->generateTemplate($variable, $receiverInfo, 'zehntech_fmepostevent_email_template');
