...
use Zehntech\PriceMatrix\Model\ResourceModel\LargeMatrix\CollectionFactory;
use Zehntech\PriceMatrix\Model\LargeMatrix;
...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection->getItems() as $record) {
            $_record = $this->largeMatrix->load($record->getId());
            $_record->delete();
            $recordDeleted++;
        }
