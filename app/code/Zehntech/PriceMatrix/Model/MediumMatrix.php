...
use Zehntech\PriceMatrix\Api\Data\MediumMatrixInterface;

class MediumMatrix extends \Magento\Framework\Model\AbstractModel implements MediumMatrixInterface
{
    /**
     * CMS page cache tag.
     */
    const CACHE_TAG = 'zt_medium_price_matrix';

    /**
     * @var string
     */
    protected $_cacheTag = 'zt_medium_price_matrix';
     ...
     * @var string
     */
    protected $_eventPrefix = 'zt_medium_price_matrix';
    ...
    {
        $this->_init('Zehntech\PriceMatrix\Model\ResourceModel\MediumMatrix');
    }
