...
use Zehntech\PriceMatrix\Api\Data\OlsMatrixInterface;

class OlsMatrix extends \Magento\Framework\Model\AbstractModel implements OlsMatrixInterface
{
    /**
     * CMS page cache tag.
     */
    const CACHE_TAG = 'zt_ols_price_matrix';

    /**
     * @var string
     */
    protected $_cacheTag = 'zt_ols_price_matrix';
     ...
     * @var string
     */
    protected $_eventPrefix = 'zt_ols_price_matrix';
    ...
    {
        $this->_init('Zehntech\PriceMatrix\Model\ResourceModel\OlsMatrix');
    }
