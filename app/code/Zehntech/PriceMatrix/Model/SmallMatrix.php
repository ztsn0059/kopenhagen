...
use Zehntech\PriceMatrix\Api\Data\SmallMatrixInterface;

class SmallMatrix extends \Magento\Framework\Model\AbstractModel implements SmallMatrixInterface
{
    /**
     * CMS page cache tag.
     */
    const CACHE_TAG = 'zt_small_price_matrix';

    /**
     * @var string
     */
    protected $_cacheTag = 'zt_small_price_matrix';
     ...
     * @var string
     */
    protected $_eventPrefix = 'zt_small_price_matrix';
    ...
    {
        $this->_init('Zehntech\PriceMatrix\Model\ResourceModel\SmallMatrix');
    }
