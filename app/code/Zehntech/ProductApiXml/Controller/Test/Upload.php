              ...
              $product->setSku($sku);
                ...
                if($supplier=="Remmer"){ 
                  ...
                  try{
                      ...
                      // $this->saveStockData($sku,$quantity,$onWeb,$price,$supplier);
                      $this->stockInventory($sku,$price,$quantity,$supplier);
                  }catch(\Exception $e){
                  ...
                  try{
                    ...
                    $product->save();
                      ...
                      $arr_product[] = $product->getSku();
                      $this->_logger->info("product of sku - " . $product->getSku() . " is not save first");
                  }catch(\Exception $e){
                    $arr_product[] = $product->getSku();
                    $this->_logger->info("Product - " . $product->getSku() . " is not save second");
                  }
