<?php
  namespace Zehntech\ProductApiXml\Controller\Mmd;
  ...
  class Upload extends \Magento\Framework\App\Action\Action
  {
    ...
    public function execute()
    {
       ...
       foreach($itemData as $singleData)
      {
        ...
        $headCategoryText =  array_key_exists('GROUP', $singleData) ?$singleData['GROUP'] : 0;
        ...
        $categoryText = array_key_exists('SUBGROUP', $singleData) ?$singleData['SUBGROUP'] : 0;
