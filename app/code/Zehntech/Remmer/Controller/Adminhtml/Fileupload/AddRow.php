...
class AddRow extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId) {
            ...
            if (!$rowData->getEntityId()) {
                ...
                $this->_redirect('remmerfile/fileupload/rowdata');
                return;
            }
        }
        ...
        $title = $rowId ? __('Edit Row Data ') . $rowTitle : __('Remmer File Upload');
    ...
    {
        return $this->_authorization->isAllowed('Zehntech_Remmer::add_row');
    }
}